        ...
        <div className="relative z-10 mx-auto w-11/12 md:w-5/6">
          ...
          {loading ? (
            ...
            <div className="mx-auto max-w-3xl py-24 text-center">
              ...
              <h3 className="mb-4 text-2xl md:text-3xl font-semibold text-[var(--text-primary)]">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center rounded-full bg-[var(--accent-primary)] px-6 py-3 font-medium text-black hover:opacity-90 transition"
              >
                Become a Partner
              </Link>
            </div>
