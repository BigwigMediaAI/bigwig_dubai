  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 z-50 flex w-full md:hidden">
        {/* Call */}
        <a
          href="tel:+971501234567" // <-- replace number
          className="flex w-1/2 items-center justify-center gap-2 bg-black py-4 text-sm font-medium text-white border-t border-white/10"
        >
          <Phone size={18} />
          Call Now
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex w-1/2 items-center justify-center gap-2 bg-[var(--accent-primary)] py-4 text-sm font-semibold text-black"
        >
