          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-[var(--accent-primary)]">
                Builds Brands & Drives Engagement
              </span>
            </h1>
            ...
            >
              We grow your brand on social platforms through strategic content,
              community management, and paid amplification — turning followers
              into engaged audiences and social channels into powerful growth
              engines.
            </p>
          </div>
        </div>
