      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-6">
          <div className="max-w-3xl">
            ...
            >
              Affiliate Marketing That <br />
              <span className="text-[var(--accent-primary)]">
                Scales Revenue Through Partnerships
              </span>
            </h1>
            ...
            >
              We design and manage high-performing affiliate programs that
              connect your brand with trusted partners, driving measurable sales
              growth through performance-based marketing — without wasted ad
              spend.
            </p>
          </div>
        </div>
