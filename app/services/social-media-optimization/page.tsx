      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-6">
          <div className="max-w-3xl">
            ...
            >
              Social Media Optimization That <br />
              <span className="text-[var(--accent-primary)]">
                Improves Visibility & Engagement
              </span>
            </h1>
            ...
            >
              We optimize your social media profiles, content strategy, and
              posting framework to increase organic reach, profile
              discoverability, and audience engagement — turning social channels
              into consistent brand assets.
            </p>
          </div>
        </div>
      </section>
