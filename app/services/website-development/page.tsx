      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-6">
          <div className="max-w-3xl">
            ...
            >
              We build high-performance, scalable websites designed for speed,
              usability, and conversion — combining clean design, robust
              development, and data-driven UX to support real business growth.
            </p>
          </div>
        </div>
      </section>
