      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-6">
          <div className="max-w-3xl">
            ...
            >
              We monitor, manage, and strengthen your brand’s online reputation
              by controlling narratives, responding to reviews, and improving
              public perception across search and social platforms — so trust
              works in your favor.
            </p>
          </div>
        </div>
