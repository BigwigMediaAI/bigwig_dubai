          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-[var(--accent-primary)]">
                Nurtures Leads & Drives Retention
              </span>
            </h1>
            ...
            >
              We create personalized, data-driven email campaigns that engage
              your audience, nurture leads, and increase customer lifetime value
              — from onboarding and newsletters to automated retention and
              re-engagement flows.
            </p>
          </div>
        </div>
